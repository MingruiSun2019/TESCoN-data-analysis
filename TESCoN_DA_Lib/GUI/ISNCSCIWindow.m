    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            instructionBox.Value = {'Instructions:', ...
                ...
                '3. Merge recording if there are multiple recordings', ...
                '4. Extract Triggered (only for ISNCSCI)', ...
                '5. Selected invalid for these channels and make notes (data will not be saved & not be used for MVC/Rest normalisation)', ...
                '6. Confirm Mapping when done', ...
                '7. Save', ...
                '8. Back - process other files', ...
                '9. ......', ...
                '8. ......', ...
                'Channel Mapping:', ...
                '1. After extraction, map channels to their correct labels', ...
                '2. Click Confirm Mapping when done'};
